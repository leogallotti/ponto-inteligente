...
//anotação para permitir que a requisição venha de qualquer lugar 
@CrossOrigin(origins = "*")
public class CadastroPJController {
	 ...
	 * anotacao @Valid serve para chamar as validacoes que criamos no dto(validator)
	 */
	@PostMapping
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		if (result.hasErrors()) {
			...
			//retorno um erro 400 enviando a lista de error(s)
	...
	private Funcionario converterDtoParaFuncionario(CadastroPJDto cadastroPJDto, BindingResult result)
		...
		//come e PJ ja coloquei como default perfil de ADMIN
